...
public class ExemploRevisao {
    ...
    public void exemplo1() {
        ...
        //10º: Se média for inferior a 50 e a frequência maior ou igual a 75, então mostre: "Aluno terá de fazer a recuperação".
        else if (notaMedia<50 && porcentagemFrequencia>=75){System.out.println("O aluno terá de fazer a recuperação.");}
        //11º: Se média for inferior a 50 e a frequência inferior a 75, então mostre: "Aluno reprovado".
